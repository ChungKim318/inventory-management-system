      ...
      .reduce((acc: AggregatedData, data: ExpenseByCategorySummary) => {
        ...
        if (!acc[data.category]) {
          acc[data.category] = {
            name: data.category,
            amount: 0,
            color: getColorFromCategory(data.category),
          };
        }
  ...
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row justify-between gap-4'>
        <div className='w-full md:w-1/3 bg-white dark:bg-gray-900 shadow rounded-lg p-6 border border-gray-100 dark:border-gray-800'>
        ...
        {/* PIE CHART */}
        <div className='grow bg-white dark:bg-gray-900 shadow rounded-lg p-4 md:p-6 border border-gray-100 dark:border-gray-800'>
